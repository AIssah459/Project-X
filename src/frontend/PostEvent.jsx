...
const PostEvent = (props) => {
    ...
    return (
        <>
        <div className='panel panel-default align-items-center'>
            <div className='panel-body'>
                ...
                <div className="input-group mb-3 w-75 start-50 justify-content-center align-items-center translate-middle-x">
